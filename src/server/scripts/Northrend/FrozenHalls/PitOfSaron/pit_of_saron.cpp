...
public:
    ...
    bool OnGossipHello(Player* player, GameObject* pGO)
    {
           if (player->getFaction() == HORDE)
          {
            ...
            if (pHordeSlave)
            {
                pHordeSlave->MonsterTextEmote("fait un geste comme sil levait un verre a votre sante", player->GetGUID());
          ...
          else
           {
            ...
            if (pAllianceSlave)
            {
                pAllianceSlave->MonsterTextEmote("fait un geste comme sil levait un verre a votre sante", player->GetGUID());
